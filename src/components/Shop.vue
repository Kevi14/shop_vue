<template>
  <div class="bg-white">
    ...
    -->
        <div class="flex z-40 lg:hidden" role="dialog" aria-modal="true">
          <!--
          ...
          >
            ...
            -->
                ...
                -->
                    ...
                    <a
                      href="#"
                      @click="add_filter_price_accending"
                      class="text-gray-500 block px-4 py-2 text-sm"
                      role="menuitem"
                      tabindex="-1"
                      id="menu-item-3"
                    ...
                    <a
                      ...
                      "
                      href="#"
                      @click="add_filter_price_descending"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <img
                          v-bind:src="
                            'https://res.cloudinary.com/hayehilhw/' + deck.image
                          "
