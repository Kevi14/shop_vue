<template>
  <div class="mb-5">
    ...
    <!-- Info -->
    <div v-if="type == 'info'" class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 my-5">
  ...
  <div class="px-4 py-2 -mx-3">
    ...
    <!-- Warning -->
    <div v-if="type == 'warning'" class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800 my-5">
  ...
  <div class="px-4 py-2 -mx-3">
    ...
    <!-- Error -->
     <div v-if="type == 'error'" class="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
...
export default {
  ...
  //   methods: {}
  mounted() {
    setTimeout(() => this.$emit("toggle_toaster"), this.time);
  },
};
</script>
